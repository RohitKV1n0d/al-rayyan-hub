...
const matches: Match[] = [
  { id: 1, status: 'FULL TIME', homeTeam: 'AL RAYYAN', homeScore: 3, awayTeam: 'AL SADD', awayScore: 1, competition: 'QATAR STARS LEAGUE' },
  { id: 2, status: 'FULL TIME', homeTeam: 'AL DUHAIL', homeScore: 2, awayTeam: 'AL RAYYAN', awayScore: 2, competition: 'QATAR STARS LEAGUE' },
  { id: 3, status: 'FULL TIME', homeTeam: 'AL RAYYAN', homeScore: 1, awayTeam: 'QATAR SC', awayScore: 0, competition: 'QATAR STARS LEAGUE' },
  { id: 4, status: 'FULL TIME', homeTeam: 'AL GHARAFA', homeScore: 0, awayTeam: 'AL RAYYAN', awayScore: 2, competition: 'QATAR STARS LEAGUE' },
  { id: 5, status: 'FULL TIME', homeTeam: 'AL RAYYAN', homeScore: 4, awayTeam: 'AL WAKRAH', awayScore: 1, competition: 'QATAR STARS LEAGUE' },
  { id: 6, status: 'FULL TIME', homeTeam: 'AL ARABI', homeScore: 1, awayTeam: 'AL RAYYAN', awayScore: 3, competition: 'QATAR STARS LEAGUE' },
];
...
export function MatchTicker() {
  ...
  return (
    <section ref={containerRef} className="py-6 bg-muted/30 overflow-hidden relative">
      ...
      <motion.div 
        ...
        initial="hidden"
        animate={controls}
        className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary to-transparent origin-right"
      />
        ...
        <div className="flex items-center gap-6">
          ...
          >
            {matches.map((match, index) => (
              ...
              >
                {/* Status Header */}
                <motion.div 
                  className="bg-muted/50 px-3 py-1.5 text-center border-b border-border relative overflow-hidden"
                >
                  <motion.div
                    initial={{ x: '-100%' }}
                ...
                <div className="p-3 space-y-2">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                      ...
                      >
                        {match.homeTeam === 'AL RAYYAN' ? (
                          <img src={logo} alt="Al Rayyan" className="w-5 h-5 object-contain" />
                        ) : (
          ...
          >
            <motion.button
              ...
              className={`p-2 border border-border rounded-lg transition-all duration-300 ${
                canScrollLeft 
