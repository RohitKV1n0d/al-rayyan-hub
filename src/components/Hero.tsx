  ...
  return (
    <section ref={containerRef} className="relative min-h-screen overflow-hidden bg-foreground">
      ...
      <motion.div style={{ opacity }} className="relative min-h-screen flex flex-col">
        ...
        {/* Main Grid */}
        <div className="flex-1 container mx-auto px-4 pt-24 pb-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-full min-h-[70vh]">
            ...
            <div className="lg:col-span-7 flex flex-col">
              ...
              <motion.div
                ...
                className="relative flex-1 rounded-2xl overflow-hidden bg-foreground/50 border border-primary-foreground/10 min-h-[400px]"
              >
                {/* Background Image */}
                <img
                  src={heroPlayer}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  ...
                  >
                    <span className="bg-primary text-primary-foreground text-[10px] font-bold px-3 py-1.5 rounded uppercase tracking-wide">
                      Breaking
                    </span>
                  ...
                  <motion.h1
                    ...
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-primary-foreground leading-[0.95] uppercase tracking-tight"
                  >
                    Lions Roar in
                    <br />
                  ...
                  <motion.p
                    ...
                    className="mt-4 text-primary-foreground/70 text-sm md:text-base max-w-md leading-relaxed"
                  >
              ...
              <motion.div
                ...
                className="mt-4 bg-foreground/50 border border-primary-foreground/10 rounded-xl p-5"
              >
                <div className="flex items-center justify-between mb-4">
                  <span className="text-primary-foreground/50 text-[10px] font-bold uppercase tracking-[0.15em]">Latest Headlines</span>
                  <button className="w-8 h-8 rounded-full border border-primary-foreground/20 flex items-center justify-center hover:border-primary hover:text-primary transition-colors">
            ...
            <div className="lg:col-span-5 flex flex-col gap-4">
              ...
              <motion.div
                ...
                className="relative flex-1 rounded-2xl overflow-hidden min-h-[280px]"
              >
                <img
                  src={playerFeatured}
